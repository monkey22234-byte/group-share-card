      ...
      <div className="max-w-5xl mx-auto px-3 sm:px-4 py-2.5 flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 min-w-0 shrink-0">
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1.5">
              <span className="font-bold text-base sm:text-lg tracking-tight text-stone-50 truncate">
                小組分享卡
              </span>
              {liveRoom ? (
        ...
        <div className="flex items-center gap-1.5 min-w-0">
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-stone-800/90 hover:bg-stone-750 border border-stone-700/80 text-stone-200 transition-all text-sm font-semibold hover:border-amber-400/50 min-w-0 max-w-[140px] xs:max-w-[190px] sm:max-w-xs md:max-w-sm truncate group shadow-xs active:scale-95"
            title="點擊切換分享主題"
          >
        ...
        <div className="flex items-center gap-1.5 shrink-0">
          ...
          {onOpenSheetDatabase && (
            <button
              ...
              className="px-2.5 py-1.5 rounded-xl bg-stone-800 hover:bg-stone-750 border border-emerald-500/40 text-emerald-300 transition-colors text-xs sm:text-sm font-semibold flex items-center gap-1.5 active:scale-95 shadow-xs"
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs sm:text-sm font-bold transition-all active:scale-95 ${
              liveRoom
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-2.5 py-1.5 rounded-xl text-xs sm:text-sm font-medium transition-all active:scale-95 ${
              isTimerRunning
          ...
          <button
            ...
            className="p-2 sm:px-3 sm:py-1.5 rounded-xl bg-stone-800 text-stone-300 hover:bg-stone-750 border border-stone-700 transition-colors text-xs sm:text-sm font-medium flex items-center gap-1.5 active:scale-95"
            title="小組成員與抽籤輪序"
          >
          ...
          <button
            ...
            className="relative px-2.5 sm:px-3 py-1.5 rounded-xl bg-gradient-to-r from-emerald-600 to-teal-600 text-white hover:from-emerald-500 hover:to-teal-500 font-bold text-xs sm:text-sm flex items-center gap-1.5 shadow-xs transition-all active:scale-95"
